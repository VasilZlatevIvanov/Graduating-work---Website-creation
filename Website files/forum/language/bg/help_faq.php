...
$help = array(
	...
	array(
		...
		1 => 'Този софтуер е създаден и лицензиран от phpBB Group. За всякакви предложения относно форум системата phpBB посетете сайта <a href="http://area51.phpbb.com/">Area51</a>.'
	),
	array(
