...
<div id="menu_div">
	...
	<a id="menu" href="javascript:unhide('bqla-tehnika'); javascript:toggle('bqla-tehnika')"><h3>Бяла техника</h3></a>
		...
		<ul>
			<li><a id="active-menu" href='hladilnici.php' style="color:blue; background:transparent;">Хладилници</a></li>
			<li><a id="sub-menu" href='peralni.php'>Перални</a></li>
			<li><a id="sub-menu" href='mialni-mashini.php'>Миялни машини</a></li>
...
<div class="product-frame" id="number1">
<div class="product-picture-main">
<a href="../img/1.jpg" target="_blank"><img src="../img/1.jpg" alt="УХАХА" width="220px" height="220px" style="overflow:hidden; border-radius:5px;"></a>
<div class="product-prise-position">
<p id="product-prise-signature">Цена - 240 лв</p>
</div>
</div>
<div style="width:140px; height:220px;float:left;position:relative;">
<div class="product-picture-small">
<a href="../img/1.jpg" target="_blank"><img src="../img/1.jpg" alt="УХАХА" width="50px" height="50px" style="overflow:hidden; border-radius:5px;"></a>
</div>
<div class="product-picture-small">
<a href="../img/1.jpg" target="_blank"><img src="../img/1.jpg" alt="УХАХА" width="50px" height="50px" style="overflow:hidden; border-radius:5px;"></a>
</div>
...
<div class="product-frame" id="number2">
<div class="product-picture-main">
<a href="../img/1.jpg" target="_blank"><img src="../img/1.jpg" alt="УХАХА" width="220px" height="220px" style="overflow:hidden; border-radius:5px;"></a>
<div class="product-prise-position">
<p id="product-prise-signature">240 лв</p>
</div>
</div>
</div>

<div class="product-frame" id="number3">
<div class="product-picture-main">
<a href="../img/1.jpg" target="_blank"><img src="../img/1.jpg" alt="УХАХА" width="220px" height="220px" style="overflow:hidden; border-radius:5px;"></a>
<div class="product-prise-position">
<p id="product-prise-signature">240 лв</p>
...
<div class="product-frame" id="number4">
<div class="product-picture-main">
<a href="../img/1.jpg" target="_blank"><img src="../img/1.jpg" alt="УХАХА" width="220px" height="220px" style="overflow:hidden; border-radius:5px;"></a>
<div class="product-prise-position">
<p id="product-prise-signature">240 лв</p>
...
<div class="product-frame" id="number5">
<div class="product-picture">
</div>
</div>

<div class="product-frame" id="number6">
<div class="product-picture">
</div>
</div>
