...
<div id="menu_div">
	...
	<a id="menu" href="javascript:unhide('uredi-za-vgrajdane'); javascript:toggle('uredi-za-vgrajdane')"><h3>Уреди за вграждане</h3></a>
		...
		<ul>
			<li><a id="sub-menu" href='furni-plot.php'>Фурни с плот</a></li>
			...
			<li><a id="active-menu" href='mialna-mashina-vgrajdane.php' style="color:blue; background:transparent;">Миялна машини</a></li>
