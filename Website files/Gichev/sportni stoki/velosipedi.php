...
<div id="header">
	<!-- Zaglavie -->
	  <a id="header" href="./index.php"><img src="../img/header.png" align="center" alt="KRASIO”" width="996" height="284"></a>
</div>
<section id="wrapper">
...
<div id="menu_div">
	...
	<a id="menu" href="javascript:unhide('sportni-stoki'); javascript:toggle('sportni-stoki')"><h3>Спортни стоки</h3></a>
		<div id="sportni-stoki" class="unhidden">
		<ul>
			<li><a id="sub-menu" href='fitnes-uredi.php'>Фитнес уреди</a></li>
			<li><a id="sub-menu" href='ski.php'>Ски</a></li>
			<li><a id="sub-menu" href='ski-obuvki.php'>Ски обувки</a></li>
			<li><a id="sub-menu" href='shteki.php'>Щеки</a></li>
			<li><a id="sub-menu" href='roleri.php'>Ролери</a></li>
			<li><a id="active-menu" href='velosipedi.php' style="color:blue; background:transparent;">Велосипеди</a></li>
			<li><a id="sub-menu" href='batuti.php'>Батути</a></li>
		</ul>
		</div>
