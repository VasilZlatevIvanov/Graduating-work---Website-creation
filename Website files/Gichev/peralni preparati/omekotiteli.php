...
<div id="menu_div">
	...
	<a id="menu" href="javascript:unhide('peralni-preparati'); javascript:toggle('peralni-preparati')"><h3>Перални препарати</h3></a>
		<div id="peralni-preparati" class="unhidden">
		<ul>
			<li><a id="sub-menu" href='prahove.php'>Прахове</a></li>
			<li><a id="active-menu" href='omekotiteli.php' style="color:blue; background:transparent;">Омекотители</a></li>
			<li><a id="sub-menu" href='tabletki.php'>Таблетки</a></li>
		</ul>
		</div>
</div>
<div id="mainframe">
